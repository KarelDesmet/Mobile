...
*/	}
    ...
    //TODO
    public Date getMinExpiryDate() throws DatabaseException {
            Date result = new Date();
            for (Category c : categoryExpiryLists.keySet()) {
                if (getCategoryExpiryList(c).getMinExpiryDate().before(result)) {
                    result = getCategoryExpiryList(c).getMinExpiryDate();
                }
            }
            return result;
    }
    ...
    //TODO
    public Date getMaxExpiryDate() throws DatabaseException {
        Date result = new Date();
        for (Category c : categoryExpiryLists.keySet()){
            if (getCategoryExpiryList(c).getMaxExpiryDate().after(result)){
                result = getCategoryExpiryList(c).getMaxExpiryDate();
            }
        }
        return result;
    }
    ...
    public void cleanExpiryProducts() throws DatabaseException {
        for (Category c : categoryExpiryLists.keySet()) {
            getCategoryExpiryList(c).cleanExpiryProducts();
        }
    }
